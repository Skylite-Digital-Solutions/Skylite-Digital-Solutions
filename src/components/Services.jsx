...
import '../styles/services.css'; // Ensure the CSS file name matches the component name
        ...
        <div className="services">
            ...
            <div className="service-cards">
                <div className="service-card">
                    ...
                    <button onClick={() => navigate('/web-development')}>Explore</button>
                </div>
                <div className="service-card">
                    ...
                    <button onClick={() => navigate('/quality-assurance')}>Explore</button>
                </div>
                <div className="service-card">
                    ...
                    <button onClick={() => navigate('/digital-seo')}>Explore</button>
                </div>
                <div className="service-card">
                    <h2>Cyber Security</h2>
                    <p>We create responsive and user-friendly websites that drive engagement and growth. Our team uses the latest technologies to deliver high-quality web solutions.</p>
                    <button onClick={() => navigate('/cyber-security')}>Explore</button>
                </div>
                <div className="service-card">
                    <h2>Blogs</h2>
