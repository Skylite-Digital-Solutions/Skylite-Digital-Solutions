        ...
        <div className="services">
            ...
            <div className="service-cards">
                <div className="service-card">
                    ...
                    <button onClick={() => navigate('/services/web-development')}>Get in Touch</button>
                </div>
                <div className="service-card">
                    ...
                    <button onClick={() => navigate('services/quality-assurance')}>Get in Touch</button>
                </div>
                <div className="service-card">
                    ...
                    <button onClick={() => navigate('/services/digital-seo')}>Get in Touch</button>
                </div>
                <div className="service-card">
                    <h2>Blogs</h2>
                    ...
                    <button onClick={() => navigate('/blogs/all-categories')}>Explore Blogs</button>
                </div>
            </div>
        </div>
    );
