        ...
        <div className="services">
            ...
            <div className="service-cards">
                <div className="service-card">
                    ...
                    <button onClick={() => alert("Get in touch clicked for Web Development")}>Get in Touch</button>
                </div>
                <div className="service-card">
                ...
                <div className="service-card">
                    ...
                    <button onClick={() => alert("Get in touch clicked for Digital Marketing & SEO")}>Get in Touch</button>
                </div>
            </div>
        </div>
    );
...
export default Services; // Export the component with the correct name
