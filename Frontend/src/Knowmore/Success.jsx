    ...
    <div className="Background-container">
        <div className="success-container">
            <h1>Your Success is Our Priority</h1>
                <p>
                    We bring expertise, dedication, and a client-centric focus to 
                    every project, empowering your business to thrive in a competitive digital landscape
                </p>
            <div className='success-footer-container'>
                <h2>Partner with us for a commitment to excellence.</h2>
                    <p>Choose us as your IT partner and experience the peace of mind that comes with knowing your business is supported by a dedicated, 
        ...
        <div className='Partner-container-main'>
                ...
                <h2>Why Partner with Us?</h2>
                    ...
                    <strong>Tailored Solutions</strong>: We recognize that every business is unique. Our approach starts with understanding 
                        your specific goals and challenges, allowing us to deliver customized solutions that align perfectly 
                    ...
                    <li>
                        ...
                        solutions, cybersecurity, and digital transformation. With years of industry experience, we ensure your project is 
                        handled by skilled professionals committed to your success.
                    </li>
                    <li>
